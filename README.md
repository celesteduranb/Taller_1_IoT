...
Este repositorio contiene los archivos correspondientes al Laboratorio 1 de IoT. El laboratorio consiste en la implementación y prueba de diferentes funcionalidades del ESP32 relacionadas con conversión analógica-digital, generación de señales analógicas y uso de periféricos básicos. Entre las actividades realizadas se incluyen pruebas con ADC y DAC, uso de un generador de señales y osciloscopio, interacción con potenciómetros y pulsadores, simulación y prueba del sensor MPU6050, y simulación de un circuito con relé.
